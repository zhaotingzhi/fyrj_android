...
public class IMotionPath extends IRObject{

	public IMotionPath(int oid) {
		super(oid);
	}
	...
	private native double getTotalDurationT(int oid);
	...
	public double getTotalDuration(){
		return getTotalDurationT(this.objectId);
	}
